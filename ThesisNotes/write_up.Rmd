...
The fourth component of the output is `mtry`. This is the number of predictors sampled for splitting at each node. 
...
The final output of this example is the confusion matrix of the prediction. This tells us how many times the prediction of sex was correct or incorrect and gives an error rate for each classification.
...
** This RF was constructed using only a training set. We only have the OOB error rate as an estimate. However, with the weight lifting data I will make a division into training and test sets** 
