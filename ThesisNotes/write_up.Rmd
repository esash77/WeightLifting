...
wl.pc <- PCA(wlTrain[, -c(1,2,55)], graph = FALSE)
...
```{r echo = FALSE}
kable(wl.pc$eig[1:10, 2:3], caption = "The first ten principal components and the percentage of variance that each contributes.") 
...
The next plot shows some of the most important variables plotted against the first two principal components.  These variables would be the ones that are best at spreading out the data.  
