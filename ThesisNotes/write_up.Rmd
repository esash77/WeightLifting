...
While it is wonderful to be able to recognize a classification tree and use it to make predictions, it is equally important to understand the basic mechanics of how a classification tree works. How does a tree decide to make a split? How does a tree decide when to stop splitting into more daughter nodes? The answer is tree control. 
...
Unfortunately, R has some round-off error, which is why the values are slightly off. **What would this value say about node purity, on average, of this classification tree?**
