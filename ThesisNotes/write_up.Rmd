...
```{r echo = FALSE}
kable(notGot, caption = "The missing numbers from the random sample")

kable(got, caption = "Numbers included in the random sample")
```
